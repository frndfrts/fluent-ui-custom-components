/**
 * ColorPicker.tsx
 * Integrated color picker component built from atomic components.
 * Professional color picker with popover interface using ColorSelector and ColorInput.
 */
...
const useStyles = makeStyles({
  ...
  popoverSurface: {
    ...
    minWidth: '320px', // Increased to match wider ColorInput
    maxWidth: '320px', // Increased to match wider ColorInput
  },
  colorPickerContent: {
    display: 'grid',
...
LegacyColorPicker.displayName = 'LegacyColorPicker'; 