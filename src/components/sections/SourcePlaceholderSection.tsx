/**
 * SourcePlaceholderSection.tsx
 * Section component for source placeholder settings including size, position, and padding.
 */
...
export interface SourcePlaceholderSectionProps {
  size?: {
    width: number;
    height: number;
    widthUnit?: string;
...
export const SourcePlaceholderSection = React.memo<SourcePlaceholderSectionProps>(({
  size,
  position,
  padding,
  units,
